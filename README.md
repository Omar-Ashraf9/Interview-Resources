...
- [Java StringTokenizer](https://www.baeldung.com/java-stringtokenizer) (optional)
...
- [Java Static Default Methods](https://www.baeldung.com/java-static-default-methods)
...
- [Java Enum Values](https://www.baeldung.com/java-enum-values) (LW FE W2T)
...
- [Java Custom Annotation](https://www.baeldung.com/java-custom-annotation)

## Exceptions
- [Java Errors vs Exceptions](https://www.baeldung.com/java-errors-vs-exceptions)
- [Java Constructors Exceptions](https://www.baeldung.com/java-constructors-exceptions) (optional)
- [Java Throw vs Throws](https://www.baeldung.com/java-throw-throws)
- [Java Common Exceptions](https://www.baeldung.com/java-common-exceptions) (optional)
...
- [Java New Custom Exception](https://www.baeldung.com/java-new-custom-exception) (optional)
...
- [IntelliJ Debugging Java Streams](https://www.baeldung.com/intellij-debugging-java-streams) (SELF IMPROVEMENT)
...
- [Java Spliterator](https://www.baeldung.com/java-spliterator)
- [Java 9 Stream API](https://www.baeldung.com/java-9-stream-api)
- [Java 8 Collectors](https://www.baeldung.com/java-8-collectors)
- [Java Optional](https://www.baeldung.com/java-optional)
- [Java Optional or Else vs Or Else Get](https://www.baeldung.com/java-optional-or-else-vs-or-else-get)
- [Java 9 Optional](https://www.baeldung.com/java-9-optional)
...
- [Java HashMap Load Factor](https://www.baeldung.com/java-hash)
...
- [Why Choose Spring?](https://www.baeldung.com/spring-why-to-choose) (OPTIONAL)
...
- [Spring Autowire Generics](https://www.baeldung.com/spring-autowire-generics)
- [Spring Core Annotations](https://www.baeldung.com/spring-core-annotations)
- [Spring Bean Annotations](https://www.baeldung.com/spring-bean-annotations)
- [Spring Qualifier Annotation](https://www.baeldung.com/spring-qualifier-annotation)
- [Spring Primary](https://www.baeldung.com/spring-primary)
...
- [Spring @Order](https://www.baeldung.com/spring-order)
- [Spring XML Injection](https://www.baeldung.com/spring-xml-injection) (OPTIONAL): Note that the popular way is using annotations
- [Spring @Component Annotation](https://www.baeldung.com/spring-component-annotation)
- [Spring Component Scanning](https://www.baeldung.com/spring-component-scanning)
- [Injecting Prototype Bean into Singleton](https://www.baeldung.com/spring-inject-prototype-bean-into-singleton)

### Optional:
- [Field Injection Considerations](https://www.baeldung.com/java-spring-field-injection-cons)
- [Avoiding Null Fields with @Autowired](https://www.baeldung.com/spring-autowired-field-null)
- [Spring @Import Annotation](https://www.baeldung.com/spring-import-annotation)
- [Injecting Beans into Unmanaged Objects](https://www.baeldung.com/spring-inject-bean-into-unmanaged-objects)
- [Autowired with Abstract Classes](https://www.baeldung.com/spring-autowired-abstract-class)

# Spring AOP

- [Spring AOP](https://www.baeldung.com/spring-aop)
- [AOP Advice in Spring](https://www.baeldung.com/spring-aop-advice-tutorial)
- [Getting Advised Method Information in Spring AOP](https://www.baeldung.com/spring-aop-get-advised-method-info)
- [AOP Pointcut in Spring](https://www.baeldung.com/spring-aop-pointcut-tutorial)
...
- [Spring MVC View Resolver](https://www.baeldung.com/spring-mvc-view-resolver-tutorial)
- [Spring XML vs Java Config](https://www.baeldung.com/spring-xml-vs-java-config)
- [Spring MVC Model, ModelMap, ModelView](https://www.baeldung.com/spring-mvc-model-model-map-model-view)
...
### Rest:
- [Spring @ResponseStatus](https://www.baeldung.com/spring-response-status)
- [Spring @RequestBody and @ResponseBody](https://www.baeldung.com/spring-request-response-body)
- [REST API Pagination in Spring](https://www.baeldung.com/rest-api-pagination-in-spring)
...
- [REST Versioning in Spring](https://www.baeldung.com/rest-versioning)

# Spring Data Access

## JDBC
- [Spring JDBC and JdbcTemplate](https://www.baeldung.com/spring-jdbc-jdbctemplate)
- [Spring JDBC Autogenerated Keys](https://www.baeldung.com/spring-jdbc-autogenerated-keys)
